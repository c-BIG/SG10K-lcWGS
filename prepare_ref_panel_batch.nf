...
include { refpanel_chunks_batch } from './modules/refpanel_chunks_batch'
include { refpanel_batch } from './modules/refpanel_batch'
...
//    BIN = 'SG10K_Health_r5.5.1.phased'
    ...
    refpanel_batch( vcf_inputs, BIN, reheader )
